<!-- Synced from .agents/workflows/reload.md — do not edit here; edit the workflow source. -->

> Reload the active-agent manifest. Use when pivoting to a new stack mid-session, or after switching projects.
