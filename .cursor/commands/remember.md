<!-- Synced from .agents/workflows/remember.md — do not edit here; edit the workflow source. -->
...
```
CONTEXT:
- User wants to remember: (Use the text the user typed after the slash command as the arguments.)
