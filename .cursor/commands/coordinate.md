<!-- Synced from .agents/workflows/coordinate.md — do not edit here; edit the workflow source. -->
...
```
CONTEXT:
- User Request: (Use the text the user typed after the slash command as the arguments.)
