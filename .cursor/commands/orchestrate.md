<!-- Synced from .agents/workflows/orchestrate.md — do not edit here; edit the workflow source. -->
...
| **Security** | security-auditor, backend-specialist, devops-engineer |
...
| `security-auditor` | Security | Vulnerabilities, Auth, pentest (red-team-tactics skill) |
| `test-engineer` | Testing | Unit, E2E, Coverage, automation |
...
| `code-reviewer` | Quality | Clean code, naming, constants |
