<!-- Synced from .agents/workflows/verify.md — do not edit here; edit the workflow source. -->
...
```
CONTEXT:
- What to verify: (Use the text the user typed after the slash command as the arguments.)
