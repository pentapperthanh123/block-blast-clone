...
```
Agents: security-auditor → test-engineer → synthesis

1. security-auditor: Configuration and code review (+ red-team-tactics skill for active testing)
2. test-engineer: Verify fixes and regression coverage
...
| `security-auditor` | Pentest / Red Team | "pentest", "red team", "exploit" (load `red-team-tactics` skill) |
