...
| **Security Review** | "security", "vulnerability", "exploit"     | `security-auditor` (+ `red-team-tactics` skill) | ✅ YES   |
| **Code Quality Review** | "review", "code review", "naming", "clean code", "magic string", "convention" | `code-reviewer` | ✅ YES       |
| **Performance**     | "slow", "optimize", "performance", "speed" | `performance-optimizer`                     | ✅ YES       |
| **Product Def**     | "requirements", "user story", "backlog", "MVP" | `project-planner`                           | ✅ YES       |
...
| **Code Quality**| review, naming, convention, magic string, clean code, constant | `code-reviewer` |
